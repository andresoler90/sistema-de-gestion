                ...
                <div class="col-md-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            {{Form::open(['route' => ['task.quality.retrieval.store'],'id'=>'form-quality'])}}
                            {{Form::hidden("registers_id",$register->id)}}
                            {{Form::hidden("register_task",$register_task->id)}}
                            {{Form::hidden("register_event",$register_event->id)}}
                            ...
                            <div class="row mt-3">
                                {{Form::hidden("stage_tasks_id",$register_event->stage_tasks_id)}}
