                        ...
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">
                                    ...
                                    <span class="badge badge-cobalt-blue">{{ count($client_documents) }}</span>
                                </h4>
                            </div>
                        </div>
                        <div class="iq-card-body" data-client='{{ $register->client->id }}' id="client">
                            {{Form::open(['route' => ['task.document.store'],'id'=>'form-documentation'])}}
                                ...
                                <table class="table table-striped table-bordered fixed-head d-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{__('Vigencia')}}</th>
                                            <th>{{__('¿Existe?')}}</th>
                                            <th>{{__('Resultado de seguimiento')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch custom-switch-text custom-control-inline">
                                                    ...
                                                    <input type="checkbox" name="valid[]" class="custom-control-input exist" id="exists-{{ $loop->index }}"
                                                    {{ (isset($document->valid) && $document->valid =='S')? 'checked':'' }} value ="{{ $document->client_documents_id?? $document->id }}">
                                                    <label class="custom-control-label" for="exists-{{ $loop->index }}" data-on-label="Si" data-off-label="No">
                                                    </label>
                                                    </div>
                                                </div>
                                            </td>
                            ...
                            <button type="button" class="btn btn-primary btn-question">{{__('Guardar')}}</button>
                            {{Form::close()}}
